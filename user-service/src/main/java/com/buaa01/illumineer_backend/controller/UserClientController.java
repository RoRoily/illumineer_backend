...
public class UserClientController {
    ...
    public Integer getCurrentUserIdHandler(BlockException exception) {
        return 1;
    }
    ...
    public Boolean getCurrentIsAdminHandler(BlockException exception) {
        return false;
    }

    public ResponseEntity<Void> updateFavoriteVideoHandler(@RequestBody List<Map<String, Object>> result,
            @RequestParam("fid") Integer fid, BlockException exception) {
    ...
    public CustomResponse setFavoriteHandler(@RequestParam("add") Integer add,
            @RequestParam("pids") String pids,
            BlockException exception) { // FIXME: ADD MAPPING
