...
CREATE TABLE `appeal_entry` (
                                ...
                                `pid` BIGINT NOT NULL COMMENT 'Paper ID',
                                ...
                                FOREIGN KEY (`appellant_id`) REFERENCES `user`(`uid`),  -- 假设 User 表对应为 user，且主键为 user_id
                                FOREIGN KEY (`owner_id`) REFERENCES `user`(`uid`)  -- 假设 User 表对应为 user，且主键为 user_id
